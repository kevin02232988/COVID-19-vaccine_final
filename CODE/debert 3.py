...
# Oversampling 준비
weights_per_sample = [1./(num_pos if label==1 else num_neg) for i, label in enumerate(labels_train)]
...
# 8️⃣ 모델 저장
# -------------------------------
save_path = "deberta_v3_focal_weighted_oversample"
model.cpu()
